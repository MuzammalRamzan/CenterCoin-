        ...
        <div className="row">
          <div className="col-sm-12">
            <div className="myrefferaltable">
              <div className="row">
                <div className="col-3">
                  <span className="refferaltext">{t("Est.APY.1")}</span>
                  <span className="bannervalue">{dailyProfit}%</span>
                </div>
                <div className="col-3">
                  <span className="refferaltext">{t("Min.Lock Amount.1")}</span>
                  <span className="bannervalue">{totalReturn}</span>
                </div>
                <div className="col-3">
                  <span className="refferaltext">{t("Withdraw.1")}</span>
                  <span className="bannervalue">{withdrawn}</span>
                </div>
                <div className="col-3">
                  <span className="refferaltext">{t("Withdrawble.1")}</span>
              ...
              <div className="row">
                <div className="col-sm-6">
                  <span className="bannervalue">{t("NoDaysLimit.1")}</span>
                </div>
              ...
              <div className="row">
                ...
                <div className="col-3">
                  <span className="bannerprofit">{t("DailyReward.1")}</span>
